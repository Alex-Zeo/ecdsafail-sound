...
BASE = ("DIALOG_GCD_FOLD_CARRY_TRUNC_W=0 KAL_DOUBLE_CARRY_TRUNC_W=0 KAL_FOLD_CARRY_TRUNC_W=0 "
        ...
        "DIALOG_GCD_UNDERFLOW_CLEAN_CMP=acc_plus_f_measured_conditioned_borrowed_windowed DIALOG_GCD_APPLY_CMP_WINDOW_BLOCKS=2")  # SOUND-OPT-7 (windowed + phase-conditioned cmp; q×T SOTA 6.347B, peak 1926). Verified-SOTA base; seg0+corrwrap (OPT-6) now seed on top to test the full stack.
SCHEMA = """
