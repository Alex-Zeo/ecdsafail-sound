...
BASE = ("DIALOG_GCD_FOLD_CARRY_TRUNC_W=0 KAL_DOUBLE_CARRY_TRUNC_W=0 KAL_FOLD_CARRY_TRUNC_W=0 "
        ...
        "DIALOG_GCD_UNDERFLOW_CLEAN_CMP=acc_plus_f_measured_conditioned_borrowed_windowed DIALOG_GCD_APPLY_CMP_WINDOW_BLOCKS=2 "  # SOUND-OPT-7 (windowed + phase-conditioned cmp)
        "SQUARE_ROW_MAX_SEG=0 ROUND84_CORRECTION_WRAP_BORROW_QUOTIENT_TOP=1")  # SOUND-OPT-8 (+ monolithic square + corrwrap; q×T SOTA 6.290B, peak 1926); reseeds stack on this
SCHEMA = """
